    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
               ...
               <a class="navbar-brand" href="adminpanel/Home">Komisi Informasi Provinsi Jambi</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <hr>
                              <form method="post" action="adminpanel/Admin_header/Simpan_data_header_ubah/<?php echo $tampil_data_header_id->id_header ?>" enctype="multipart/form-data">
