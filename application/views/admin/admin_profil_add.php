                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           <form method="post" action="adminpanel/Admin_profil/Simpan_profil" enctype="multipart/form-data">

                            <div class="row">
                                <div class="col-md-4">
                                    <input type="taxt" name="nama" value="" class="form-control" placeholder="Nama "/>
                                </div>
                            </div>
                            <hr>
                             <div class="row">
