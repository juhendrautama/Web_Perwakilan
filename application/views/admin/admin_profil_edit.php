                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           <form method="post" action="adminpanel/Admin_profil/Simpan_ubah/<?php echo $tampil_data_profil_id->id_profil; ?>" enctype="multipart/form-data">

                            <div class="row">
                                <div class="col-md-4">
                                    <input type="taxt" name="nama" value="<?php echo $tampil_data_profil_id->nama; ?>" class="form-control" placeholder="Nama "/>
                                </div>
                            </div>
                            <hr>
                             <div class="row">
