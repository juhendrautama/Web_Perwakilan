                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                              <form method="post" action="adminpanel/Admin_baner/Simpan_data_baner" enctype="multipart/form-data">

                             <div class="row">
                                <div class="col-md-4">
                                    <input type="taxt" name="judul_baner" value="" class="form-control" placeholder="Judul"/>
                                </div>
                                 <div class="col-md-4">
                        ...
                        <hr>
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                 <?php $no=1; foreach($tampil_data_baner->result()as $rs){?> 
                                    <tr class="odd gradeX">
                                        <td><?php echo $no ?></td>
                                        <td><?php echo $rs->judul_baner; ?></td>
                                        <td><?php echo $rs->link; ?></td>
                                        <td><img width="50px" src="img/gambar_baner/<?php echo $rs->gambar_baner; ?>"></td>
                                        <td><?php echo $rs->tgl_baner; ?></td>
                                        <td >
                                            <center>
                                            <a Onclick="return confirm('apakah yakin ingin di Hapus ?');" href="adminpanel/Admin_baner/Hapus_baner/<?php echo $rs->id_baner; ?>" class="btn-sm btn-danger">Hapus</a>
                                           </center>     
                                        </td>
                                    </tr>
                                  <?php $no++;   }?>            
